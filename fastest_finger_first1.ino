...
#define button4 5 //button4 attach to
#define button5 9 //button5 attach to
...
void loop()
{
  ...
  if(1 == flag)
  {
    ...
    if(b1State == 0)
    {
      ...
      digitalWrite(LED3,LOW);
      digitalWrite(LED4,LOW); 
      while(digitalRead(button5)); //detect the button4,if pressed,out of the while loop
    }
    ...
    //If the button4 press the first
    if(b4State == 0)
    {
      flag = 0;
      digitalWrite(LED5, LOW);
